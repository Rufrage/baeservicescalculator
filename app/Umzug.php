...
{
    protected $fillable = [
        'vorname', 'nachname', 'adresse', 'telefon', 'email', 'rechnungsempfänger', 'ansprechpartner', 'kakao_talk_id', 'position',
        'wohnzimmer_sofa_3_sitze', 'wohnzimmer_sofa_2_sitze', 'wohnzimmer_sitzlandschaft', 'wohnzimmer_sessel_mit_armlehnen', 'wohnzimmer_sessel_ohne_armlehnen', 'wohnzimmer_stuhl',
